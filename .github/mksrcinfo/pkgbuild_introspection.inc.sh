# pkgbuild_introspection.inc.sh — vendored from falconindy/pkgbuild-introspection
# https://github.com/falconindy/pkgbuild-introspection (MIT License)
# Provides srcinfo_write_from_pkgbuild, which generates .SRCINFO content from a
# PKGBUILD using only bash + coreutils (no makepkg, no Arch environment,
# no docker). Used by .github/workflows to regenerate .SRCINFO in CI.
